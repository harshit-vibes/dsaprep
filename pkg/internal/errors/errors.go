...
var Registry = map[string]*AppError{
	...
	ErrEnvCorrupt: {
		...
		Suggestion:  "Delete ~/.cf/config.yaml and run 'cf init'",
		Recoverable: true,
		Action:      ActionAutoFix,
	},
	ErrHandleNotSet: {
		...
		Suggestion:  "Run: cf config set cf_handle YOUR_HANDLE",
		Recoverable: false,
	...
	ErrCredentialsMissing: {
		...
		Suggestion:  "Run: cf config set cookie 'YOUR_COOKIE_STRING'",
		Recoverable: false,
		Action:      ActionUserPrompt,
	},
	ErrSessionExpired: {
	...
	ErrCFLoginFailed: {
		...
		Category:    CatExternal,
		Message:     "Failed to authenticate with Codeforces",
		Suggestion:  "Update your cookie: cf config set cookie 'NEW_COOKIE'",
		Recoverable: true,
		Action:      ActionUserPrompt,
	},
